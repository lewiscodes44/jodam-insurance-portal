    ...
    <div className="auth-shell auth-shell--wide">
      ...
      <div className="auth-card">
        ...
        <form onSubmit={submit} className="form-stack">
          ...
          <div className="form-grid"><label>Username<input value={form.username} onChange={e => update('username', e.target.value)} required /></label><label>Password<input value={form.password} onChange={e => update('password', e.target.value)} type="password" required /></label></div>
